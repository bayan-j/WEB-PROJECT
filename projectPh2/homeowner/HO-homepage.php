...
<html>
   ...
   <body>
      <div class="header" >
         ...
         <ul>
            <li style="text-decoration:underline ;"><a href="HO-homepage.php">Home</a></li>
            <li><a href="HO-PreviousRequest.php">Previous Request</a></li>
            <li><a href="HO-newRequest.php">New Request</a></li>
            <li><a href="HO-viewOffer.php">Offer list</a></li>
            <li><a href="HO-currentBooking.php">Current Booking</a></li>
            <li><a href="HO-PreviousBooking.php">Previous Booking</a></li>
         </ul>
         <?php if(!empty($_SESSION["User_code"]) && $_SESSION["h_type"] == "ho"){?>
            <div class="dropdown">
               <image src="../image/userIcon.png" class="image" alt="User Icon">
               <ul>
                  <li><a href="HO-profile.php">View Profile</a></li>
                  <br><br>
                  <li><a href="#"><br></a></li>
            ...
            <div class="box">
               ...
               <div class="card">
                  ...
                  <div class="pra">
                     ...
                     <p style="text-align: center;" >
                        <a class="button" href="HO-newRequest.php" >New</a>
                        <a class="button" href="HO-PreviousRequest.php" >previous</a>
                     </p>
                  </div>
               </div>
               <!------------  offerlist   ----------->
               <div class="card">
                  ...
                  <div class="pra">
                     ...
                     <br>
                     <p style="text-align: center;">
                        <a class="button" href="HO-viewOffer.php" >GO! </a>
                     </p>
                  </div>
               </div>
               <!------------  MY Booking   ----------->
               <div class="card">
                  ...
                  <div class="pra">
                     ...
                     <br>
                     <p style="text-align: center;">
                        <a class="button" href="HO-currentBooking.php" >current </a>
                        <a class="button" href="HO-PreviousBooking.php">previous</a>
                     </p>
                  </div>
               </div>
            </div>
